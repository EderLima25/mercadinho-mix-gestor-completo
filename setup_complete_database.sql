...
-- 3. Remover e recriar tabelas problemáticas
...
-- 10. Criar função para criar perfil automaticamente
...
BEGIN
  ...
  -- Atribuir role padrão de cashier
...
-- 13. Criar perfis para usuários existentes (se não existirem)
INSERT INTO public.profiles (id, full_name)
SELECT 
  id, 
...
-- 14. Criar roles para usuários existentes (se não existirem)
INSERT INTO public.user_roles (user_id, role)
SELECT 
  id, 
  'admin' as role
...
-- Finalizar
SELECT 'Banco de dados configurado completamente!' as resultado;